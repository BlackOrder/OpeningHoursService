...
const opening_hours_1 = __importDefault(require("opening_hours"));
...
class OpeningHoursService {
    ...
    constructor(initialHours, timezone) {
        this.openingHours = [];
        this.openingHoursInstance = new opening_hours_1.default('Mo-Su closed'); // Default: closed all days
    ...
    adjustDayForTimezone(dayOfWeek, fromTimezone, toTimezone) {
        ...
        const localDate = (0, date_fns_tz_1.fromZonedTime)(date, fromTimezone);
        const targetDate = (0, date_fns_tz_1.toZonedTime)(localDate, toTimezone);
    ...
    convertTimeWithDayChange(time, dayOfWeek, fromTimezone, toTimezone) {
        ...
        const localDate = (0, date_fns_tz_1.fromZonedTime)(dateInFromZone, fromTimezone);
        const dateInToZone = (0, date_fns_tz_1.toZonedTime)(localDate, toTimezone);
        const convertedTime = (0, date_fns_tz_1.format)(dateInToZone, 'HH:mm');
    ...
    combineAdjacentRanges(hours) {
        ...
        for (let i = 0; i < hours.length; i++) {
            ...
            while (next &&
                ...
                current = Object.assign(Object.assign({}, current), { closes: next.closes });
    ...
    convertToZonedDate(time, dayOfWeek) {
        ...
        const now = new Date();
        const zonedTime = (0, date_fns_tz_1.toZonedTime)(now, this.userTimezone);
    ...
    generateOpeningHoursInstance() {
        const hoursString = this.openingHours
            ...
            .join('; ');
        if (hoursString === '') {
            this.openingHoursInstance = new opening_hours_1.default('Mo-Su closed');
        }
        else {
            // Recreate the opening_hours instance with the updated string
            this.openingHoursInstance = new opening_hours_1.default(hoursString);
        }
    }
    /**
